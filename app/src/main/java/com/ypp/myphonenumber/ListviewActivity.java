...
/**
 * Created by adminstrator on 2016/12/5.
 */
public class ListviewActivity extends ListView implements OnScrollListener {
    ...
    public ListviewActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void onRefreshComplete() {
        state = DONE;
        lvHeaderLastUpdatedTv.setText("最近更新:" + Utils.getTime());
        changeHeaderViewByState();
    }
